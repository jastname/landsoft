...
<body>
    <h3>학생 성적 등록</h3>
    <form name="studentFrm" id="studentFrm" method="post" action="score_input_proc.do">
        ...
        <table class="dataTable">
            ...
            <tr>
                <th>시험 년도</th>
                <td><input type="text" name="score_year"></td>
            </tr>
            <tr>
                <th>구분</th>
                <td>
                    <label><input type="radio" name="score_divion" value="M" /> 중간고사</label>
                    <label><input type="radio" name="score_divion" value="F" /> 기말고사</label>
                </td>
            </tr>
            ...
            <c:forEach var="subject" items="${studentSubject}">
                <c:if test="${param.grade == subject.studentGrade}">
                    <tr>
                        ...
                        <td><input type="text" name="score_${subject.subjectId}"></td>
                    </tr>
                </c:if>
            </c:forEach>
        </table>
    ...
    <div class="button-container">
        <a href="#" onclick="fn_saveScore();">등록</a>
    </div>
</body>
</html>
